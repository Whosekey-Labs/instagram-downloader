...
for(const file of [manifest.background.service_worker,...Object.values(manifest.icons),...manifest.content_scripts.flatMap(item=>item.js),'app.html','privacy.html','LICENSE','THIRD_PARTY_NOTICES.md']) await stat(path.join('dist',file));
